...
static const std::string IMAGE_PATH = "/home/matheus/Pictures/Turtlebot/";
//static const std::string IMAGE_PATH = "/home/matheus/lena.jpg";
...
int publishImageWithoutImage_transport(std::string filename)
{
    ROS_INFO("Topic : %s", TOPIC_NAME.c_str());
    ROS_INFO("IMAGE PATH : %s", IMAGE_PATH.c_str());
    ros::NodeHandle nh;
    std::string image_path = IMAGE_PATH + filename;
	std::cout << std::endl<< "ARGV ::" << image_path<< std::endl ;
...
int main(int argc, char** argv)
{
    ...
    publishImageWithoutImage_transport(argv[1]);
    return 0;
}
